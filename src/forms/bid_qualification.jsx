export const formSchema = {
  ...
  "components": [
    ...
    },
    {
      ...
      "description": "What is the situation at the client that drives the opportunity?",
      "validate": {
        "required": true
      }
    },
    ...
    },
    {
      ...
      "id": "Field_1jbx2qg",
      "key": "select_7ffzu9",
      "description": "Is the client in a priority domain that we've identified as a target based on our expertise?",
      "validate": {
        "required": true
      }
    },
    {
      ...
      "description": "Can we WIN and how? (win themes / quality / price / relationship / accelerators / cases.. why Vega IT)",
      "validate": {
        "required": true
      }
    },
    {
      ...
      "id": "Field_15jac1v",
      "key": "textfield_3vdd8",
      "description": "Have we delivered similar work in other organizations, which we could leverage to win and profitably deliver on this specific opportunity? (e.g. consider domain, technical expertise and technology platform)",
      "validate": {
        "required": true
      }
    },
    ...
    },
    {
      ...
      "description": "Salesforce Opportunity link, so that we can easily import outcomes for further analysis and enhance Salesforce compliance",
      "validate": {
        "required": true
      }
    },
